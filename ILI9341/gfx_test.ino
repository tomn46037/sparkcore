...
void updateLights() {
    ...
    digitalWrite( D1, temp & 0x00000001);
    temp = temp >> 1;    
    digitalWrite( D2, temp & 0x00000001);
    temp = temp >> 1;
    digitalWrite( D3, temp & 0x00000001);
    temp = temp >> 1;
    digitalWrite( D4, temp & 0x00000001);
    temp = temp >> 1;
    digitalWrite( D5, temp & 0x00000001);
    temp = temp >> 1;
    digitalWrite( D6, temp & 0x00000001);
    temp = temp >> 1;
    digitalWrite( D7, temp & 0x00000001);
